export default {
  ...
  views: {
    ...
    budgets: {
      ...
      noBudgetsDescription: 'Create a budget to plan and track your financial goals.',
      addFirstBudget: 'Create your first budget',
      yearlyView: 'Yearly',
      monthlyView: 'Monthly',
      ...
      addBudgetForm: {
        title: 'New Budget',
        name: { label: 'Budget Name', placeholder: 'e.g. Conservative 2026' },
        year: { label: 'Year' },
        submit: { label: 'Create' },
      ...
      budgetItems: {
        title: 'Budget Items',
        noItems: 'No budget items defined.',
        addItem: 'Add Item',
        addToList: 'Add to list',
        budgetBy: 'Budget by',
        saveItems: 'Save',
        saveSuccess: 'Budget items saved!',
        saveError: 'Failed to save budget items.',
      ...
      progress: {
        ...
        accounts: 'accounts',
        recommendations: {
          on_pace_to_exceed: 'On pace to exceed yearly budget',
